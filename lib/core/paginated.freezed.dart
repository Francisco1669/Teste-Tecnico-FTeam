...
class _$PaginatedImpl<T> extends _Paginated<T> {
  ...
  @override
  String toString() {
    return 'Paginated<$T>(items: $items, currentPage: $currentPage, totalPages: $totalPages, hasMore: $hasMore, isLoadingMore: $isLoadingMore)';
  }
